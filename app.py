...
st.subheader('This application will help to identify the development of the country.')

# Lets take the inputs
gdp = st.number_input('Enter the GPPP of a country (GDP per population)')
...
input_list = [child_mort,exports,health,imports,income,inflation,life_expcy,fert,gdp]
